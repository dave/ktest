...
func (a *Assertions) HasErrorExternal(theError error, expectedId string, msgAndArgs ...interface{}) bool {
	return HasErrorExternal(a.t, theError, expectedId, msgAndArgs...)
}
...
func (a *Assertions) IsErrorExternal(theError error, expectedId string, msgAndArgs ...interface{}) bool {
	return IsErrorExternal(a.t, theError, expectedId, msgAndArgs...)
}
